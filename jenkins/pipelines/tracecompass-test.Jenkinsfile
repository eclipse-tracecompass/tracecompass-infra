        ...
        stage('Checkout') {
            steps {
                container('tracecompass') {
                    ...
                    checkout([$class: 'GitSCM', branches: [[name: '$GERRIT_BRANCH_NAME']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'BuildChooserSetting', buildChooser: [$class: 'GerritTriggerBuildChooser']]], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'GitHub bot (username/token)', refspec: '$GERRIT_REFSPEC', url: '$GERRIT_REPOSITORY_URL']]])
