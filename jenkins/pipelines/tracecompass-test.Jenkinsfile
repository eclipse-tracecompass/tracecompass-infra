            ...
            steps {
                container('tracecompass') {
                    withCredentials([string(credentialsId: 'gpg-passphrase', variable: 'KEYRING_PASSPHRASE')]) {
                        sh 'mvn clean install -B -Dgpg.passphrase="${KEYRING_PASSPHRASE}" -DdocDestination=${WORKSPACE}/doc/.temp -Dmaven.repo.local=/home/jenkins/.m2/repository --settings /home/jenkins/.m2/settings.xml ${MAVEN_ARGS}'
